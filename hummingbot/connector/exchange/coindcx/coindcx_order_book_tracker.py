...
class CoindcxOrderBookTracker(OrderBookTracker):
    ...
    def __init__(self, trading_pairs: Optional[List[str]] = None,):
        super().__init__(CoindcxAPIOrderBookDataSource(trading_pairs), trading_pairs)
        ...
        self._order_books: Dict[str, CoindcxOrderBook] = {}
        self._saved_message_queues: Dict[str, Deque[CoindcxOrderBookMessage]] = \
    ...
    async def _track_single_book(self, trading_pair: str):
        ...
        order_book: CoindcxOrderBook = self._order_books[trading_pair]
