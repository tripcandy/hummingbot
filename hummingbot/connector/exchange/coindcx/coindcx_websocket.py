...
from hummingbot.connector.exchange.coindcx.coindcx_utils import RequestId, get_ms_timestamp
...
class CoindcxWebsocket(RequestId):
    ...
    def __init__(self, auth: Optional[CoindcxAuth] = None):
        self._auth: Optional[CoindcxAuth] = auth
