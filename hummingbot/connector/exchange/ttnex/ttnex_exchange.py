...
class TTNExExchange(ExchangeBase):
    ...
    def __init__(self,
        ...
        """
        :param ttnex_api_key: The API key to connect to private Titan Exchange APIs.
        :param ttnex_secret_key: The API secret.
        ...
        while True:
            try:
                ...
                self.logger().network(f"Unexpected error while fetching trading rules. Error: {str(e)}",
                                      exc_info=True,
                                      app_warning_msg="Could not fetch new trading rules from Titan Exchange. "
    ...
    async def _create_order(self,
        ...
        api_params = {"instrument_name": ttnex_utils.convert_to_exchange_trading_pair(trading_pair),
        ...
        try:
            ...
            self.logger().network(
                f"Error submitting {trade_type.name} {order_type.name} order to Titan Exchange for "
                f"{amount} {trading_pair} "
                f"{price}.",
                exc_info=True,
        ...
        while True:
            try:
                ...
                self.logger().network("Unexpected error while fetching account updates.",
                                      exc_info=True,
                                      app_warning_msg="Could not fetch account updates from Titan Exchange. "
    ...
    async def cancel_all(self, timeout_seconds: float):
        ...
        try:
            ...
            self.logger().network(
                ...
                exc_info=True,
                app_warning_msg="Failed to cancel all orders on Titan Exchange. Check API key and network connection."
            )
