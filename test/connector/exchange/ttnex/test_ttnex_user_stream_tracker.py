...
class TTNExUserStreamTrackerUnitTest(unittest.TestCase):
    api_key = conf.ttnex_api_key
    api_secret = conf.ttnex_secret_key

    @classmethod
    def setUpClass(cls):
        cls.ev_loop: asyncio.BaseEventLoop = asyncio.get_event_loop()
        cls.ttnex_auth = TTNExAuth(cls.api_key, cls.api_secret)
        cls.trading_pairs = ["BTC-USDT"]
        cls.user_stream_tracker: TTNExUserStreamTracker = TTNExUserStreamTracker(
            ttnex_auth=cls.ttnex_auth, trading_pairs=cls.trading_pairs)
